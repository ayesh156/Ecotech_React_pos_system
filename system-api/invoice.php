...
<table style="padding: 15px;">
	...
	<br/>
	<span style="font-size: 25px; font-weight: bold;">' . number_format($totalAmount, 2) . '</span>
	</td>
	</tr>
	</tbody>
	</table>
	...
	<span style="color: #9E9E9E;">' . $notes . '</span>
	</td>
	</tr>
    <tr>
	<td style="padding: 15px;" colspan="4">
	<span style="font-size:16px;">Footer:<br/></span>
	<span style="color: #9E9E9E;">' . $footerNotes . '<br/></span>
...
// set margins
                ...
                <div
                    ...
                    <div>Hi,</div>
                    <div style="margin-top: 10px;">Please see the attached Invoice_#' . $invoiceNumber . ' The due amount is LKR ' . number_format($totalAmount, 2) . ' The invoice
                    ...
                    <div style="margin-top: 10px;">Best regards,</div>
                        ...
                        // Attach the PDF
                        $mail->addStringAttachment($pdfContent, 'Invoice_#' . $data['id'] . '.pdf');
